        ...
        <tbody>
          <tr>
            ...
            <td valign="middle" style={{ padding: 14 }}>
              ...
              <span style={{ display: "inline-block", background: "var(--gist-secondary)", color: "#ffffff", padding: "7px 14px", borderRadius: 4, fontSize: 12, fontFamily: "sans-serif", fontWeight: 600, whiteSpace: "nowrap" }}>
  ...
  return (
    <div style={{ border: "1px solid #e5e7eb", borderRadius: 8, overflow: "hidden", margin: "20px 40px", background: "#fafafa" }}>
      ...
      <div style={{ padding: 16 }}>
        ...
        <span style={{ display: "inline-block", background: "var(--gist-secondary)", color: "#ffffff", padding: "8px 18px", borderRadius: 4, fontSize: 13, fontFamily: "sans-serif", fontWeight: 600 }}>
...
function PresentingCard({ data }: { data: PresentingPreviewData }) {
  return (
    <div style={{ padding: "20px 40px" }}>
      ...
      <span style={{ display: "inline-block", background: "var(--gist-secondary)", color: "#ffffff", padding: "10px 20px", borderRadius: 4, fontSize: 13, fontFamily: "sans-serif", fontWeight: 600 }}>
        {data.ctaLabel || "Learn More"}
      </span>
    </div>
  );
