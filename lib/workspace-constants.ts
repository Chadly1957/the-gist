...
export type WorkspaceInfo = { id: string; slug: string; name: string; area: string; domain: string | null; latitude: number | null; longitude: number | null; timezone: string | null };
