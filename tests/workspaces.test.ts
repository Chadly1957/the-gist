...
test("email credentials, sender identity and generated URLs stay within their workspace", async () => {
  ...
  const town = { id: "town", slug: "town", name: "The Gist Town", area: "Town", domain: null, latitude: null, longitude: null, timezone: null, primaryColor: "#15803d", secondaryColor: "#166534" };
